...
## Description
Sudden astonishment from an unexpected event.

## Visual Cues for AI Training
Raised brows, wide eyes, open mouth, brief freeze in motion.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person surprised shocked expression`
  - `surprised face open mouth wide eyes`
  - `woman shocked surprised gasp`
  - `person caught off guard surprised`
  - `surprise party reaction face`

## Recommended Datasets
FER2013, AffectNet, CK+, JAFFE, RAF-DB
