...
Soft smile, unfocused distant gaze, slightly downturned eyes.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person nostalgic looking at old photos`
  - `woman reminiscing wistful expression`
  - `older person nostalgic memory face`
  - `person wistful faraway look`
  - `nostalgic smile old memory`
