...
## Description
Respect and warm approval toward someone or something impressive.

## Visual Cues for AI Training
Look for upward gaze, open posture, slight smile, wide eyes.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person looking up admiringly at someone`
  - `crowd applauding hero`
  - `student admiring teacher`
  - `fan admiring athlete`
  - `person gazing at artwork with admiration`

## Recommended Datasets
AffectNet, FER2013, EMOTIC
