...
## Description
Feelings of love, tenderness, and attraction toward another.

## Visual Cues for AI Training
Soft gaze, gentle smile, tilted head, leaning toward partner.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `couple romantic tender moment`
  - `person romantic longing look`
  - `romantic gaze between two people`
  - `couple affectionate tender expression`
  - `person romantic dreamy expression`
