...
## Description
Strong aversion or revulsion toward something offensive.

## Visual Cues for AI Training
Nose wrinkle, raised upper lip, pulled back chin, narrowed eyes.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person disgusted face expression`
  - `woman recoiling in disgust`
  - `man disgusted smell face`
  - `disgust facial expression closeup`
  - `person wrinkling nose in disgust`

## Recommended Datasets
FER2013, AffectNet, CK+, JAFFE
