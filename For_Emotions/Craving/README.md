...
## Description
Intense desire or longing for something specific.

## Visual Cues for AI Training
Dilated pupils, parted lips, leaning forward, focused gaze.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person craving food expression`
  - `man longingly looking at food`
  - `woman desiring something intensely`
  - `person craving look eyes`
  - `hungry person staring at food`
