...
## Description
Feeling distress when witnessing others suffering or in pain.

## Visual Cues for AI Training
Raised inner brows, pressed lips, concerned eyes, leaning toward subject.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person empathizing with someone crying`
  - `friend comforting sad person`
  - `compassionate face empathy`
  - `person wincing seeing others pain`
  - `empathetic expression caring face`
