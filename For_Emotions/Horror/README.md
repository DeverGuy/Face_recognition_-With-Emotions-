...
## Description
Extreme fear combined with revulsion and shock.

## Visual Cues for AI Training
Maximum eye opening, mouth agape, hands to face, full body recoil.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person horrified expression shock`
  - `man horrified face hands on cheeks`
  - `woman horrified screaming expression`
  - `horror face extreme fear`
  - `person witnessing something terrible`
