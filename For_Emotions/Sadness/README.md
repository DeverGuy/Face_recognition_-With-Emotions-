...
## Description
Sorrow and unhappiness, often from loss or disappointment.

## Visual Cues for AI Training
Raised inner brows, drooping mouth corners, tears, slumped posture.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person sad crying expression`
  - `sad face downcast eyes`
  - `woman sad tears face`
  - `grieving person sad expression`
  - `depressed sad face closeup`
