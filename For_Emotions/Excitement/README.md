...
## Description
Energetic anticipation and enthusiasm about something.

## Visual Cues for AI Training
Wide eyes, big smile, raised arms, forward-leaning body.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person excited happy jumping`
  - `child excited Christmas morning`
  - `fan excited at sports event`
  - `person excited good news reaction`
  - `woman thrilled excited expression`

## Recommended Datasets
FER2013, AffectNet, EMOTIC
