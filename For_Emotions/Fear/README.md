...
## Description
Intense emotional response to perceived threat or danger.

## Visual Cues for AI Training
Wide eyes, raised brows, open mouth, pale skin, tense body.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person scared fearful expression`
  - `woman frightened face closeup`
  - `fear facial expression horror`
  - `person afraid eyes wide`
  - `scared child fearful face`
