...
## Description
Engaged curiosity and attention toward something.

## Visual Cues for AI Training
Slightly raised brow, tilted head, forward lean, focused eyes.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person interested leaning forward`
  - `curious person attentive face`
  - `interested expression raised eyebrow`
  - `person intrigued by something`
  - `attentive student interested face`
