...
## Description
Attraction and longing of a romantic/physical nature. [Use ethical, non-explicit training data only]

## Visual Cues for AI Training
IMPORTANT: Use only non-explicit, ethically sourced images. Focus on facial cues: dilated pupils, slightly parted lips, sustained eye contact, subtle smile. Consult dataset ethics guidelines before use.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person attracted romantic longing expression`
  - `flirtatious expression subtle`
  - `person attracted to someone look`
  - `romantic desire expression face`
  - `longing attraction facial cues`
