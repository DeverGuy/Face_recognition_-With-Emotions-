...
## Description
Disengagement and tedium from lack of stimulation.

## Visual Cues for AI Training
Drooping eyelids, slack mouth, head resting on hand, glazed eyes.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `bored person resting chin on hand`
  - `student bored in class`
  - `person staring blankly bored`
  - `bored face expression`
  - `person yawning from boredom`
