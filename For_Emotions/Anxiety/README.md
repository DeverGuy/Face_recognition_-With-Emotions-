...
## Description
Worry and nervousness about uncertain outcomes.

## Visual Cues for AI Training
Raised inner brows, tense shoulders, hunched posture, darting eyes.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person anxious nervous expression`
  - `worried person biting nails`
  - `anxious woman waiting`
  - `stressed person before exam`
  - `nervous person sweating`
