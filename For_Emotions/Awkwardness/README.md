...
## Description
Social discomfort and embarrassment in uncomfortable situations.

## Visual Cues for AI Training
Forced smile, averted gaze, neck touching, stiff posture.

## Recommended Search Queries
Use these on Unsplash, Pexels, Getty, or Google Images:
  - `person awkward social situation`
  - `man embarrassed uncomfortable expression`
  - `awkward handshake moment`
  - `person cringing awkwardly`
  - `uncomfortable smile forced`
